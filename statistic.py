...
if __name__ == '__main__':
    ...
    print(
        f"TVM -O0 VGG16:\nAvg. #Func {func_count / 3}, Avg. #Asm Inst {asm_count / 3}\n"
    )
    ...
    print(
        f"Glow Mobilenet v2:\nAvg. #Func {func_count / 3}, Avg. #Asm Inst {asm_count}\n"
    )
